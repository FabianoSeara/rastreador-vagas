...
const Icon = {
  Plus: (p) => <svg width={p.size||16} height={p.size||16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>,
  Trash: (p) => <svg width={p.size||15} height={p.size||15} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg>,
  ExternalLink: (p) => <svg width={p.size||11} height={p.size||11} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>,
  Search: (p) => <svg width={p.size||15} height={p.size||15} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>,
  Briefcase: (p) => <svg width={p.size||16} height={p.size||16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>,
  TrendingUp: (p) => <svg width={p.size||16} height={p.size||16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>,
  X: (p) => <svg width={p.size||18} height={p.size||18} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>,
};
...
function JobTracker() {
  ...
  return (
    <div style={{ fontFamily: "'Iowan Old Style', 'Georgia', serif", background: "#EEF1EC", minHeight: "100vh", color: "#20261F", padding: "32px 20px" }}>
      <style>{`
      ...
      <div style={{ maxWidth: 880, margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", marginBottom: 6, flexWrap: "wrap", gap: 12 }}>
          ...
          >
            <Icon.Plus size={16} /> Nova vaga
          </button>
        </div>

        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 12, margin: "24px 0" }}>
          <StatCard icon={<Icon.Briefcase size={16} />} label="Candidaturas" value={stats.total} />
          <StatCard icon={<Icon.TrendingUp size={16} />} label="Em andamento" value={stats.entrevistas} />
          <StatCard icon={<Icon.TrendingUp size={16} />} label="Ofertas" value={stats.ofertas} accent="#4C8C5B" />
          <StatCard icon={<Icon.TrendingUp size={16} />} label="Taxa de resposta" value={`${stats.taxa}%`} />
        </div>
        ...
        <div style={{ display: "flex", gap: 10, marginBottom: 18, flexWrap: "wrap", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6, background: "#fff", border: "1px solid #D6DBCF", borderRadius: 8, padding: "8px 12px", flex: "1 1 200px" }}>
            <Icon.Search size={15} color="#8A9285" />
            <input
              value={query}
                  ...
                  <div style={{ flex: "1 1 220px", minWidth: 0 }}>
                    ...
                    {job.link && (
                      <a href={job.link} target="_blank" rel="noreferrer" style={{ fontFamily: "'Helvetica Neue', Arial, sans-serif", fontSize: 12, color: "#5B7B9A", display: "inline-flex", alignItems: "center", gap: 4, marginTop: 6, marginLeft: 16, textDecoration: "none" }}>
                        Ver vaga <Icon.ExternalLink size={11} />
                      </a>
                    )}
                  </div>
